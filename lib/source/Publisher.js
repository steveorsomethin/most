...
Publisher.prototype.event = Publisher.prototype.onNext = function(x) {
	if(!this.active) {
		return;
	}
...
Publisher.prototype.end = Publisher.prototype.onCompleted = function(x) {
	if(!this.active) {
		return;
	}
	this.active = false;
...
Publisher.prototype.error = Publisher.prototype.onError = function(e) {
	if(!this.active) {
		return;
	}
	this.active = false;
